...
function showMap(position) {
 ...
 // Supongamos que tienes una lista de objetos que contienen información de las escuelas
 var schools = [
  ...
  { name: "Escuela 8", lat: -34.844724, lng: -58.473382, note: "EES n¿N°22" },
  ...
  // Agrega más información de escuelas aquí
];
